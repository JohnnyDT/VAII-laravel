            ...
            <div class="row">
                <div class="col-md-12 row-box-shadow">
                    <nav class="navbar nav-style">
                        ...
                        <ul class="nav">
                            <li class="nav-item">
                                <a href="index" class="btn btn-secondary button-style">DOMOV</a>
                            </li>
                            <li class="nav-item">
                                <a href="about" class="btn btn-secondary button-style">O KLUBE</a>
                            </li>
                            <li class="nav-item">
                                <a href="table" class="btn btn-secondary button-style">TABULKA</a>
                            </li>
                            <li class="nav-item">
                                <a href="present" class="btn btn-secondary button-style">FOTKY</a>
                            </li>
                            <li class="nav-item">
                                <a href="login" class="btn btn-secondary button-style login">Log In</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="container text-left text-md-left">
            <div class="row text-left text-md-left">
                ...
                <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Debitis eveniet consequuntur
                        maiores suscipit cum excepturi dolore facere placeat iusto saepe at corrupti accusantium s
                        eveniet consequuntur mai</p>
                ...
                <div class="row align-items-center">
                    <div class="text-center">
                        ...
                        <p>Copyrigth 2022 All rights reserved <a href="#" style="text-decoration: none;"><strong
                                    class="text-warning"> Johnny</strong></a></p>
